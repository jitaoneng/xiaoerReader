...
class Read extends React.Component{
    constructor(props) {
        ...
        this.state = {
            ...
            chapter: '',
            show: false,
            readSetting: store.get('readSetting') || {fontSize: '18', backgroundColor: 'rgb(196, 196 ,196)'},
                                                ...
                                                (
                                                    <div onClick={(e) => e.stopPropagation()}>
                                                        ...
                                                        <div className={styles.color}>
                                                            <i onClick={this.changeBackgroudColor} style={{backgroundColor: 'rgb(196, 196 ,196)'}}></i>
